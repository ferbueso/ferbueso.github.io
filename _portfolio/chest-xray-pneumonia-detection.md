...
**Key highlights:**
- Built and trained a Convolutional Neural Network (CNN) on labelled chest X-ray datasets
- Focused on model interpretability to support clinical decision-making
